    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-12">
        ...
        <div className="space-y-4">
          {FEATURES.map(({ title, symbol, body, tip }) => (
            <div
              key={title}
