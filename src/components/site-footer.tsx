...
const SOCIAL = [
  {
    href: "https://github.com/vishalmshah",
    label: "GitHub",
  ...
  {
    href: "https://www.instagram.com/signal_path_sketches/",
    label: "Instagram",
  ...
  {
    href: "https://www.linkedin.com/in/vishalmanishshah/",
    label: "LinkedIn",
...
export function SiteFooter() {
  return (
    <footer
      ...
      style={{ borderColor: "var(--border-color)", background: "var(--bg-content)" }}
    >
